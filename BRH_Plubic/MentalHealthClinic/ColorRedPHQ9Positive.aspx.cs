...
{
    public partial class ColorRedPHQ9Positive : System.Web.UI.Page
    {
        string sql = "";
        DataTable dt;
        ...
        protected void btn_submit_PHQ9_ServerClick(object sender, EventArgs e)
        {
            ...
            Response.Redirect("PHQ9.aspx?id=" + m_id + "&spst20=" + txtS + "&phq9=" + txtD);            
        }
    }
}