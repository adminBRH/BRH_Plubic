    ...
    <div class="col-8 mx-auto">
            <div class="card">
                <div class="card-body" style="background-color:lightcoral" id="div_green">
                    ...
                    <div class="card-body col-5 mx-auto" style="background-color:floralwhite" id="div_yellow" >
                    ...
                    <div class="col-12 mx-auto text-center">
                            <button type="button" class="btn btn-primary" id="btn_submit_red" onserverclick="btn_submit_red_ServerClick" disabled="disabled" runat="server">Next</button>
                        </div>
                </div>
            </div>
        </div>
