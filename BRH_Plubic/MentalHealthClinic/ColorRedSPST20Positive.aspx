<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ColorRedSPST20Positive.aspx.cs" Inherits="BRH_Plubic.MentalHealthClinic.ColorRedSPST20Positive" %>
            ...
            <div class="card">
                <div class="card-body" style="background-color:lightpink" id="div_green">
                    ...
                    <div class="col-12 mx-auto text-center">
                            <button type="button" class="btn btn-primary" id="btn_submit_SPST20" onserverclick="btn_submit_SPST20_ServerClick" runat="server">Next</button>
                        </div>
                </div>
            </div>
        </div>
