...
{
    public partial class GAD7toSPST20pos : System.Web.UI.Page
    {
        string sql = "";
        DataTable dt;
        ...
        protected void btn_submit_GAD7_to_spst_ServerClick(object sender, EventArgs e)
        {
            string m_id = id;
            ...
            Response.Redirect("SPST20.aspx?id=" + m_id + "&gad7=" + txtA + "&spst20=" + txtS + "&phq9=" + txtD);
        }
    }
}