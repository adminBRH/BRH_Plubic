<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SPST20Negative.aspx.cs" Inherits="BRH_Plubic.MentalHealthClinic.SPST20Negative" %>
            ...
            <div class="card">
                <div class="card-body" style="background-color:navajowhite" id="div_green">
                    ...
                    <div class="card-body col-5 mx-auto" style="background-color:azure" id="div_yellow" >
                         <input type="text" class="form-control mt-1" placeholder="ชื่อ" id="spst20neg_fname" runat="server"/>
                         <input type="text" class="form-control mt-1" placeholder="นามสกุล" id="spst20neg_lname" runat="server"/>
                         <input type="text" class="form-control mt-1" placeholder="เบอร์โทร" id="spst20neg_pnumber" runat="server"/>
                         <input type="text" class="form-control mt-1" placeholder="LineID" id="spst20neg_line" runat="server"/>
                    </div>  
                    <div class="col-12 mt-3 mx-auto text-center">
                            <button type="button" class="btn btn-primary" id="btn_submit_spst20neg" onserverclick="btn_submit_spst20neg_ServerClick"  runat="server">Submit</button>
                    </div>
                    </div>
                </div>
