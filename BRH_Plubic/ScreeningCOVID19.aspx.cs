...
{
    public partial class ScreeningCOVID19 : System.Web.UI.Page
    {
        string sql = "";
        DataTable dt;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["BeforToWork"] != null)
            {
                ...
                {
                    Response.Write("<script>alert('คุณไม่มีสิทธิ์ปริ้น !!'); window.location.href='ScreenCovid19.aspx';</script>");
                }
            }
        }
        ...
        protected void btnsubmit_ServerClick(object sender, EventArgs e)
        {
            ...
            if (result == 1)
            {
                ...
                Response.Redirect("ScreeningCovid19Result.aspx");
            }
            else if (result == 2)
            {
        ...
        public int InsertData()
        {
            ...
            sql = "INSERT INTO screencovid" +
                "(sc_fname, sc_lname, sc_dob, sc_question, sc_score, sc_datetime, sc_status, sc_detail, sc_risk, cp_id)" +
                "VALUES('" + fname + "', '" + lname + "', '" + DOB +"', '" + Question + "', '" + Score + "', current_timestamp(), 'confirm', '" + Detail + "', '" + risk + "', '" + cpid + "');";
        ...
        public Boolean Print(string id)
        {
            ...
            sql = "select s.*,concat(s.sc_fname,' ',s.sc_lname) as 'sc_fullname' " +
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                string[] sc_dob = dt.Rows[0]["sc_dob"].ToString().Split(' ');
                lbl_DOB.Text = "..." + sc_dob[0].ToString() + "...";
