<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="QuarantineCOVID.aspx.cs" Inherits="BRH_Plubic.ConsentForm.QuarantineCOVID" %>
        ...
        <table width="100%" id="printableArea" runat="server" data-toggle="modal" data-target="#InputModal" style="width: 21cm; margin-left: auto; margin-right: auto;" border="0">
                                ...
                                <table width="100%" border="1" style="border:outset;">
                                    ...
                                    <tr>
                                        <td colspan="2" style="border:1px;" class="text-center">
                                            <b>
                                            หนังสือแสดงความยินยอมขอคำปรึกษา<br />
                                            ตรวจรักษากับแพทย์ผ่านระบบอินเตอร์เน็ต
                                            </b>
                                        </td>
                                    </tr>
                                </table>
            ...
            <tr>
                ...
                <td width="95%">
                    ...
                    <label id="lb_1EN" hidden="hidden">I was clearly clarified by physician/dentist and/or his/her assistants about the pros and cons which might happen from the treatment via telemedicine and consent to accept the treatment/consultation including following all the advice suggested by treating physician/dentist and/or his/her assistants.</label>
                </td>
            </tr>
            <tr>
                <td class="text-right align-text-top">2. </td>
                <td>
                    <label id="lb_2TH">ข้าพเจ้ายินยอมโดยสมัครใจให้คณะแพทย์ ทันตแพทย์-พยาบาล และ/หรือ บุคลากรอื่นๆ ในทีมสุขภาพของโรงพยาบาลกรุงเทพระยอง ทำการตรวจรักษา การบันทึกข้อมูลสุขภาพ รวมถึงการถ่ายนิ่งและบันทึกภาพเคลื่อนไหว ที่เกี่ยวข้องกับการรักษาและ/หรือ กระทำการใดๆ ตามหลักวิชาชีพทางการแพทย์ได้ตลอดระยะเวลาที่ข้าพเจ้า ให้คำปรึกษา ตรวจรักษากับแพทย์ผ่านระบบอินเตอร์เน็ต โดยจะต้องอธิบายข้อมูล รายละเอียดให้แก่ข้าพเจ้าได้เข้าใจและยินยอมก่อนที่จะดำเนินการอีกทั้งเปิดโอกาสให้ข้าพเจ้าซักถามจนเป็นที่พอใจ เพื่อการปรับปรุงการบริการ</label>
                    <label id="lb_2EN" hidden="hidden">I voluntarily consent to the treatment, record health information including take photos and video that is related to the treatment and/or appropriated medical procedures provided by the treating physician/dentist and/or his/her assistants and/or other personnel from Bangkok Hospital Rayong throughout the period of my treatment/consultation via telemedicine. Prior to any procedure, the details must be explained to me to my comprehension and agreement as well as giving me the opportunity to inquire further should I feel inadequately informed.</label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <br /><br />
                    <p>
                        <label id="lb_respectTH">ณ ที่นี้ข้าพเจ้า ขอแสดงความยินยอมเพื่อรับการรักษา</label>
                        <label id="lb_respectEN" hidden="hidden">I hereby to receive the treatment detailed above</label>
                    </p>
                </td>
            </tr>
        </table>
