<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="historyslip.aspx.cs" Inherits="BRH_Plubic.Happymoney.historyslip" %>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <asp:UpdatePanel ID="UpdatePanel_slip" runat="server">
            <ContentTemplate>
                <img src="..." id="img_id" runat="server" />
    ...
    <script>
        function get_id(id, money) {
            ...
            var img = document.getElementById('<%= img_id.ClientID %>');
