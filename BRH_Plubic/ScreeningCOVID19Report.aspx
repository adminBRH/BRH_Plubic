<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ScreeningCOVID19Report.aspx.cs" Inherits="BRH_Plubic.ScreeningCOVID19Report" %>
        ...
        <div class="card card-body">
            <asp:GridView ID="GridView1" CssClass="mx-auto" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
                <Columns>
                    ...
                    <asp:BoundField HeaderText="วันเดือนปีเกิด" DataField="sc_dob" DataFormatString="{0: dd/MM/yyyy}"></asp:BoundField>
                    ...
                    <asp:TemplateField HeaderText="PRINT" HeaderStyle-CssClass="title_bg" ItemStyle-HorizontalAlign="Left">
                        <ItemTemplate>
                            <a class="btn btn-outline-primary" href="ScreeningCovid19.aspx?id=<%# Eval("sc_id") %>">
